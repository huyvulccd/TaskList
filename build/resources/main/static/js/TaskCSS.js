window.onload = function(){
    let tasksLength = document.querySelectorAll("tbody tr").length;
    console.log(tasksLength)
    if (tasksLength == 1){
        let tablee = document.querySelector(".tablee")
        console.log(tablee)
        tablee.innerHTML = "<img src='/images/notFound.png' class = 'notFound' height = 500></img>"
    }
...
function GenerateTaskDetails(id,title,content,status) {
    ...
    detailTag.querySelector('h1').innerHTML = "<br>" + title
